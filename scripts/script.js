...
// Starts the game
function startGame() {
window.localStorage.setItem("indexOfCard", 0);
...
"indexOfCard",
parseInt(window.localStorage.getItem("indexOfCard")) + 1
);
} else if (next == false) {
window.localStorage.setItem(
"indexOfCard",
parseInt(
window.localStorage.getItem("indexOfCard") < 1
? 0
: window.localStorage.getItem("indexOfCard") - 1
)
);
...
var stateScenarios = JSON.parse(window.localStorage.getItem("scenarios"));
var scenario =
stateScenarios[parseInt(window.localStorage.getItem("indexOfCard"), 10)];
